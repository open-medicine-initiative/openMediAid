    ...
    (function (p) {
        ...
        (function (p) {
            ...
            a.a = function () {
                ...
                return{mb: ["authenticity_token", /^__RequestVerificationToken(_.*)?$/], r: function (a, b) {
            ...
            a.ca = a.k = function () {
                ...
                var d = [], e, f = 0;
                return{jb: b, end: c, zb: function (b) {
                    if (e) {
            ...
            (function () {
                ...
                var f = w && "\x3c!--test--\x3e" === w.createComment("test").text, h = f ? /^\x3c!--\s*ko(?:\s+([\s\S]+))?\s*--\x3e$/ : /^\s*ko(?:\s+([\s\S]+))?\s*$/,
                    g = f ? /^\x3c!--\s*\/ko\s*--\x3e$/ : /^\s*\/ko\s*$/, k = {ul: !0, ol: !0};
                a.e = {Q: {}, childNodes: function (a) {
            ...
            a.a.Aa = function () {
                function b(b, d, e, f, h) {
                    ...
                    s = [];
                    n = p;
                    for (m = q; n || m;)q = l[n][m] - 1, m && q === l[n][m - 1] ? k.push(g[g.length] = {status: e, value: d[--m], index: m}) :
